...
class StubKernel(Kernel):
    ...
    banner = "Nebi stub kernel — no Jupyter kernel is installed in this pixi environment."
    ...
    kernel_cls = type(
        ...
        (StubKernel,),
        {
            ...
            "banner": (
                ...
                f"'{args.workspace}' has no Jupyter kernel installed.\n"
                "Any cell you run will print the install instructions."
            ),
        },
    )
